...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('battery_history', function (Blueprint $table) {
            ...
            $table->timestamp('interval_end')->index(); // End of 15-min interval
            ...
            $table->decimal('soc_end', 5, 2)->nullable(); // SOC at end of interval
            $table->decimal('soc_change', 5, 2)->nullable(); // SOC change during interval
            ...
            $table->decimal('energy_kwh', 8, 4)->nullable(); // Energy transferred during interval
            ...
            $table->unsignedBigInteger('battery_session_id')->nullable(); // Link to session if applicable
            ...
            $table->decimal('opportunity_cost_sek', 10, 4)->nullable(); // What we could have saved with different action
            ...
            $table->foreign('battery_session_id')->references('id')->on('battery_sessions')->onDelete('set null');
        });
    }
